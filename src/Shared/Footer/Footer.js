    ...
    return (
        <footer className="footer p-10 text-white" id='footer'>
          ...
          <div>
            ...
            <a href='/allinventories' className="link link-hover">Spice</a> 
            <a href='/allinventories' className="link link-hover">Selling</a> 
            <a href='/allinventories' className="link link-hover">Marketing</a> 
            <a href='/allinventories' className="link link-hover">Import</a> 
            <a href='/allinventories' className="link link-hover">Advertisement</a>
          </div> 
          <div>
          ...
          <div>
            ...
            <a href='/blogs' className="link link-hover">Terms of use</a> 
            <a href='/blogs' className="link link-hover">Privacy policy</a> 
            <a href='/blogs' className="link link-hover">Cookie policy</a>
          </div> 
          <div>
            ...
            <p>Copyright © 2024 - All right reserved by SPICE TASTE Authority</p>
          </div>
      </footer>
    );
};
